...
class OwmBatchTest {
    ...
    void max_OfBatchWithSingleRow_ShouldBeCorrect() {
        ...
        assertThat(series).containsExactly(TempSeries.Entry.of(LocalDate.parse("2020-01-01"), Temp.kelvin(100)));
    }
    ...
    void max_OfBatchWithMultipleDates_ShouldBeCorrect() {
        ...
        assertThat(series).containsExactly(
            TempSeries.Entry.of(LocalDate.parse("2020-01-01"), Temp.kelvin(100)),
            TempSeries.Entry.of(LocalDate.parse("2020-01-02"), Temp.kelvin(120))
        );
    }
    ...
    void max_OfBatchWithMultipleRowsForDate_ShouldBeCorrect() {
        ...
        TempSeries series = batch.maxs();
        assertThat(series).containsExactly(
            TempSeries.Entry.of(LocalDate.parse("2020-01-01"), Temp.kelvin(120))
        );
    }
}